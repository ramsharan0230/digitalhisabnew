    ...
    <section style="margin:20px 0">
        ...
        <div style="display:flex;justify-content:space-between;padding:10px 0;">
            <div style="display:flex;">
                <p style="font-size:14px;margin:0; width:90px;">Status : <span style="font-size:14px;">Open </span></p>
                
            </div>
            <div style="display:flex;">
                <p style="font-size:14px;margin:0;width:120px; margin-left:150px"><b>Due Amount :<span style="font-size:14px;"><b>Rs. {{$grand_total-$collected_amount}}</b></span></b></p>
