...
<div class="content">
	...
	@endif
<form method="post" action="{{route('purchase.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
				...
				<div class="box-body row">
						...
						<div class="row">
							<div class="col-md-10">
								<select class="form-control" name="vendor_id">
									<option selected="true" disabled="true">Select Vendors</option>
									@foreach($vendors as $vendor)
									<option value="{{$vendor->id}}" {{$detail->vendor_id==$vendor->id?'selected':''}}>{{$vendor->name}}</option>
									@endforeach
								</select>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label></label>
									<button class="btn btn-success addVendor">+</button>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-6 col-sm-12">
						<div class="form-group">
						    ...
						    <img src="{{asset('images/'.$detail->bill_image)}}" class="img-responsive">
						    @endif
						</div>
					</div>
					<!-- <div class="form-group">
					...
					<div class="col-lg-12 col-sm-12">
					    <div class="form-group total_paid hidden">
							...
							<input type="text" name="total_paid" class="form-control total_paid_amount" value="{{$detail->total_paid}}" data-value="">
						</div>
					</div>
