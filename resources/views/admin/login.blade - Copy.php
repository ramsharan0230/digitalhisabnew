    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="https://pixabay.com/photos/student-typing-keyboard-text-woman-849828/" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <img src="{{asset('images/webhousenepa.png')}}" alt="logo" class="logo">
              </div>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Digital</b> Daybook 123</a>
  </div>
  <!-- /.login-logo -->
