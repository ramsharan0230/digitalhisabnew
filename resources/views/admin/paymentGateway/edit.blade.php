...
@section('title','Edit PaymentGateway')
@push('styles')
...
<section class="content-header">
    <h1>Payment Gateway<small>Edit</small></h1>
    <ol class="breadcrumb">
...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form method="post" action="{{route('payment-gateway.update',$detail->id)}}" enctype="multipart/form-data">
                {{csrf_field()}}
