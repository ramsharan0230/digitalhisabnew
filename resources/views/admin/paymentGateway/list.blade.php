...
@section('title','Payment GatewayList')
@push('styles')
<link rel="stylesheet" href="{{ asset('backend/plugins/datatables/dataTables.bootstrap.css') }}">
@endpush
@section('content')
<section class="content-header">
  <h1>Payment Gateway<small>List</small></h1>
    <a href="{{route('payment-gateway.create')}}" class="btn btn-success">Add Payment Gateway</a>
    <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($details as $detail)
                  ...
                  <tr id="{{ $detail->id }}">
                      ...
                      <td>
                        <a class="btn btn-info edit" href="{{route('payment-gateway.edit',$detail->id)}}" title="Edit"><span class="fa fa-edit"></span></a>
                        <form method= "post" action="{{route('payment-gateway.destroy',$detail->id)}}" class="delete btn btn-danger">
                        {{csrf_field()}}
