<form method="post" action="{{route('payFullPurchasePayment')}}">
	{{csrf_field()}}
    <div class="form-group">
  		<input type="hidden" name="vat_id" value="{{$vat->id}}">
      	<label>Total Amount</label>
      	<input type="text" name="full_amount" class="form-control full_amount" value="{{$vat->total}}" readonly="">
    </div>	
  	<div class="form-group">
		  <?php
      $amount_to_be_paid=$vat->total-$vat->total_amount_of_purchase_amount_paid;
      ?>
    ...
    <div class="form-group deposited_at hidden">
     ...
     <div class="form-group">
  	...
  	<div class="form-group">
  		<input type="submit" name="submit" class="btn btn-success submitButton" >
  	</div>
</form>
