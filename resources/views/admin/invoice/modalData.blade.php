<form method="post" action="{{route('payCollectedAmount')}}">
	{{csrf_field()}}
    <div class="form-group">
  	...
  	<div class="form-group">
		<?php
		$amount_to_be_paid=$invoice->grand_total-$invoice->collected_amount
		?>
    	<label>Amount To Be Paid</label>
    	<input type="text" name="amount_to_be_paid" class="form-control remaining_amount" value="{{$amount_to_be_paid}}" readonly="">
  	</div>
    <div class="form-group">
    ...
    <div class="form-group hidden tds_amount">
  	...
  	<div class="form-group">
  		<input type="submit" name="submit" class="btn btn-success submitButton hidden" value="submit">
  	</div>
</form>
