              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($details as $detail)
                  <tr id="{{ $detail->id }}">
                      ...
                      <td>
                        <a class="btn btn-info edit" href="{{route('vendor.edit',$detail->id)}}" title="Edit"><span class="fa fa-edit"></span></a>
                        <form method= "post" action="{{route('vendor.destroy',$detail->id)}}" class="delete btn btn-danger">
                        {{csrf_field()}}
