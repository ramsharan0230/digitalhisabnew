...
<section class="content-header">
  <h1>Invoice<small>List</small></h1>
    <a href="{{route('bank.create')}}" class="btn btn-success">Add Bank</a>
    <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($details as $detail)
                  <tr id="{{ $detail->id }}">
                      ...
                      <td>
                        <a class="btn btn-info edit" href="{{route('bank.edit',$detail->id)}}" title="Edit"><span class="fa fa-edit"></span></a>
                        <form method= "post" action="{{route('bank.destroy',$detail->id)}}" class="delete btn btn-danger">
                        {{csrf_field()}}
